...
<CardGrid>
  ...
  <LinkCard
    title="Providers"
    href="./providers"
    description="Choose which GitHub/GitLab instances appear in the dashboard"
  />
  <LinkCard
    title="Migrating Filters"
    href="./migrating-filters"
    description="Translate legacy GitHub search filters to the DSL"
  />
  <LinkCard
    title="PR Section"
    href="./pr-section"
