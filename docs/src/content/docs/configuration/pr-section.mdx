...
This setting defines the provider-agnostic filter DSL for the PRs in the section's table.

Don't specify `type = "pr"` for this setting. The dashboard always adds that filter for
PR sections.
